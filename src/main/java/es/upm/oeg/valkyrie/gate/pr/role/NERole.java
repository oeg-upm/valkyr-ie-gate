 ...
 * @author Pablo
 */
public class NERole extends Model{
    ...
    public NERole(String name, String annotationSet){
        this.Name= name;
    ...
    public void addGazeteer(String Encoding, Boolean CaseSensitive, String FeatureSeparator, Boolean LongestMatchOnly,  String GazetteerDir) throws MalformedURLException, ResourceInstantiationException{
